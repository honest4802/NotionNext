...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '7756c73a6f7f488695487306f9b8ddd6',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '没有什么好说的🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.syong.link', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '心情如歌,博客，数码', // 网站关键词 英文逗号隔开
  ...
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'honest4802/NotionNext', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  ...
  COMMENT_GITALK_OWNER: process.env.NEXT_PUBLIC_COMMENT_GITALK_OWNER || 'honest4802', // 你的用户名 e.g tangly1024
  COMMENT_GITALK_ADMIN: process.env.NEXT_PUBLIC_COMMENT_GITALK_ADMIN || 'honest4802', // 管理员用户名、一般是自己 e.g 'tangly1024'
